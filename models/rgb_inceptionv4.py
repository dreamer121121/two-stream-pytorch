...
__all__ = ['rgb_inceptionv4']

model_urls = {'Inceptionv4': 'http://data.lip6.fr/cadene/pretrainedmodels/inceptionv4-8e4777a0.pth'}
...
def rgb_inceptionv4(num_classes=101, pretrained=True):
    ...
    if pretrained:
        pretrained_dict = model_zoo.load_url(url = model_urls['Inceptionv4'],model_dir='/home/xt/two-stream/two-stream-pytorch/models')
