...
def rgb_resnet101(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls['resnet101'],model_dir='/home/xt/two-stream-pytorch/models'))
    return model
...
def rgb_resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_dict = model_zoo.load_url(url = model_urls['resnet152'],model_dir='/home/xt/two-stream-pytorch/models')
        model_dict = model.state_dict()
